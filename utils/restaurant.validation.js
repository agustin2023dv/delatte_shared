...
const validateRestaurantUpdate = (req, res, next) => {
    ...
    if (horarios && (!Array.isArray(horarios) || horarios.some(h => typeof h !== 'object' ||
        typeof h.dia !== 'string' ||
    ...
    if (capacidadMesas && (!Array.isArray(capacidadMesas) || capacidadMesas.some(c => typeof c !== 'object' ||
